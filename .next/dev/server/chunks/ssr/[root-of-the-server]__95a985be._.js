...
const Navbar = ({ children, className })=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$diagnostic_lab$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(motion.div, {
        ref: ref,
        className: cn(// ⬇️ Changed from sticky with white backdrop to fully transparent container
        "fixed top-6 inset-x-0 z-50 flex justify-center bg-transparent pointer-events-none", className),
...
const NavBody = ({ children, className, visible })=>{
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$diagnostic_lab$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(motion.div, {
        animate: {
            ...
            backgroundColor: visible ? "rgba(255, 255, 255, 0.65)" // ⬅️ semi-transparent when scrolled
             : "rgba(255, 255, 255, 0.35)",
            y: visible ? 10 : 0,
            scale: visible ? 0.98 : 1,
            boxShadow: visible ? "0 4px 30px rgba(140, 82, 255, 0.2)" // soft purple glow
             : "none"
        },
        transition: {
            type: "spring",
        ...
        className: cn("pointer-events-auto relative z-[60] mx-auto flex w-full max-w-5xl flex-row items-center justify-between rounded-full px-6 py-3", "border border-white/30 shadow-sm backdrop-blur-md", className),
        children: children
    }, void 0, false, {
        fileName: "[project]/diagnostic_lab/components/ui/resizable-navbar.tsx",
        lineNumber: 37,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__95a985be._.js.map